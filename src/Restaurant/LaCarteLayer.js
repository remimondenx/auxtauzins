...
const entrees = {
  ...
  content: [
    ...
    false,
    {
      food: 'Assiette de charcuterie maison',
      price: 20,
    },
    { food: 'Pâté de foie de canard maison', price: 16 },
    ...
    //   price: 15,
    // },
    { food: 'Tranche de foie gras de canard', price: 25 },
    { food: "Tranche de foie gras d'oie", price: 30 },
...
const poissons = {
  ...
  content: [
    ...
    { food: 'Coquilles Saint-Jacques à la Provençale', price: 28 },
...
const sauces = {
  ...
  content: [
    ...
    { food: 'Ris de veau sauce financière', price: 26 },
    { food: 'Tournedos Landais', description: 'foie gras et cèpes', price: 32 },
  ],
};
...
const vins = {
  ...
  content: [
    ...
    {
      food: 'Château Seguin (2016)',
      price: 50,
      description: '1/2 bouteille 30€',
    },
    {
      food: 'L’Angelot de Seguin (2016)',
      price: 40,
      description: '1/2 bouteille 24€',
    },
    { subtitle: 'St Emilion' },
    { food: 'La Croix Fourche (2016)', price: 40 },
    { food: 'Château Grand Bert (2014)', price: 40 },
    {
      food: 'Château Patris Grand Cru (2015)',
      price: 52,
      description: '1/2 bouteille 28€',
    },
    // { food: 'Château Tertre De Calon, Montagne St Emilion (2015)', price: 30 },
    { food: 'Château de Beaulieu, Montagne de St Emilion - 1/2 bouteille (2015)', price: 20 },
    { subtitle: 'St Estephe' },
    ...
    { food: 'Vieux cardinal Lafaurie', price: 40 },
    ...
    { subtitle: 'Alsace' },
    { food: 'Riesling', price: 30 },
    { food: 'Gewurztraminer', price: 30 },
    { subtitle: 'AOC' },
    ...
    { subtitle: 'Plate' },
    // { food: 'Evian', price: 4 },
    { food: '1/2 Vittel', price: 4 },
    { food: 'Vittel', price: 5 },
    { subtitle: 'Gazeuse' },
    // { food: '1/2 Badoit', price: 3 },
    // { food: 'Badoit', price: 4 },
    { food: '1/2 San Pellegrino', price: 4 },
    { food: 'San Pellegrino', price: 5 },
  ],
};
