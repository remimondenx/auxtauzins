            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              <div className={classes.margin}>
                <ul style={{ paddingLeft: 0 }}>
                  <li>
                    <Typography>
                      Le restaurant vous accueille de 12h00 à 13h45 ainsi que de
                      19h30 à 21h00
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      Le restaurant est fermé le <strong>vendredi soir</strong>{' '}
                      (sauf réservation groupe), le{' '}
                      <strong>dimanche soir</strong> et le{' '}
                      <strong>lundi toute la journée</strong>
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      En saison, <strong>du 14 juillet au 20 août</strong>, le
                      restaurant est ouvert tous les jours (excepté le lundi
                      midi)
                    </Typography>
                  </li>
                  <li>
                  ...
                  <li>
                    <Typography>
                      Chèque vacances et tickets restaurant acceptés
                    </Typography>
                  </li>
                </ul>
              </div>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              <div className={classes.margin}>
                <ul style={{ paddingLeft: 0 }}>
                  ...
                  <li>
                    <Typography>
                      Possibilité de <strong>privatiser</strong> salle de
                      réunion ou salon pour tout séminaire
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      Organisation de baptême, communion, anniversaire, mariage
                    </Typography>
                  </li>
                </ul>
              </div>
