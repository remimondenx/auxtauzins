...
const entrees = {
  ...
  content: [
    ...
    {food: 'Landaise salad', description: 'Salad, tomatoes, asparaguses, gizzards, smoked duck breast, foie gras', price: 25},
    false,
...
const canard = {
  ...
  content: [
    ...
    false,
    {food: 'Roasted duck', description: 'grilled or with green pepper sauce', price: 20},
...
const viandes = {
  ...
  content: [
    ...
    {food: 'Landais Tournedos', description: 'beef steak on garlic crouton with a slice of foie gras and cèpes', price: 30},
    false,
...
const desserts = {
  ...
  content: [
    ...
    false,
    {food: 'Choice of water ice , 2 scoops', description: 'pear, blackcurrant, lemon, mandarin', price: 8},
    {food: 'Choice of ice-creams, 2 scoops', description: 'vanilla, coffee, pistachios, strawberries, grape rums, prunes', price: 8},
    false,
    {food: 'Melba peach', price: 8},
    {food: 'The coffee ice cream', price: 8},
    {food: 'The chocolate ice cream', price: 8},
    {food: 'The cardinal cup', description: 'brown sorbet, cream of brown', price: 8},
    {food: 'The Colonel Cup', description: 'lemon sorbet, vodka', price: 9},
    {food: 'Williamine cup', description: 'pear sorbet, pear alcohol', price: 9},
    {food: 'The cup d\'Artagnan', description: 'prune ice, prune, armagnac and chantilly', price: 9},
    false,
    {food: 'Coffee', price: 2.80},
