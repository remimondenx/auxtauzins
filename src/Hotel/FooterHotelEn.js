            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              <div className={classes.margin}>
                <ul style={{ paddingLeft: 0 }}>
                  ...
                  <li>
                    <Typography>
                      Breakfast available for an extra cost of 9,50€
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      We accept pets for an extra cost of 8€
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      <strong>Half-board</strong> 39€
                    </Typography>
                  </li>
                  <li>
                    <Typography>Additional bed 20€</Typography>
                  </li>
                  <li>
                    <Typography>
                      The hotel is closed on <strong>Sundays evening</strong>{' '}
                      and on <strong>Mondays</strong>
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      <strong>From July 14 to August 20</strong>, the hotel is
                      open every day
                    </Typography>
                  </li>
                </ul>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              <div className={classes.margin}>
                <ul style={{ paddingLeft: 0 }}>
                  <li>
                    <Typography>
                      Free <strong>Wifi</strong> connection in the hotel
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      <strong>Air conditioned</strong> | Flat screen TV |
                      Chamber hairdryer
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      <strong>Swimming pool</strong> | Minigolf
                    </Typography>
                  </li>
                  <li>
                    <Typography>Babyfoot | Ping Pong | Billiard</Typography>
                  </li>
                  <li>
                  ...
                  <li>
                    <Typography>
                      <strong>Parking</strong> with supervision | Cycling garage
                    </Typography>
                  </li>
                </ul>
              </div>
